# This script allows you to tell a story. It demonstrates the simple use of
# if/else statements to evaluate user input that generates a cute fairy
# story.
...
subprocess.check_call(["say", story])
